  ...
  if(isset($_SESSION["authenticated"]) && $_SESSION["authenticated"] === true){
      ...
      <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" >
        <table>
          <tr>
            <td>
              <input type="hidden" name="customer_id" value="<?php echo htmlspecialchars($_GET["id"]);?>">           
            </td>
          </tr>
          <tr class="d-flex">
            <td class="col-5">
          ...
          <tr>
            <td>
            <input class="btn btn-success" type="submit" name="updateRecord" value="Update Record" style="margin: 1em;"/>
